...
<div id="menu">
<li><a id="menu_users" class="ui-state-default ui-corner-all" title='menu_users' href="{site_url}/user/"><Users><?php echo lang('sg_menu_users'); ?></a></li>
<li><a id="menu_regions" class="ui-state-default ui-corner-all"  title='menu_regions' href="{site_url}/region"><?php echo lang('sg_menu_regions'); ?></a></li>
<?php if ($this->sg_auth->is_logged_in()): ?>
<li><a id="menu_account" class="ui-state-default ui-corner-all"  title='menu_account' href="{site_url}/user/self"><?php echo lang('sg_menu_account'); ?></a></li>
<?php endif; ?>
<?php if ($this->sg_auth->is_logged_in() && !strpos(uri_string(), 'logout')): ?>
<li><a id="menu_logout" class="ui-state-default ui-corner-all"  title='menu_logout' href="{site_url}/auth/logout"><?php echo lang('sg_menu_logout'); ?></a></li>
<?php endif; ?>
<?php if ( ! $this->sg_auth->is_logged_in()): ?>
<li><a id="menu_login" class="ui-state-default ui-corner-all"  title='menu_login' href="{site_url}/auth"><?php echo lang('sg_login'); ?></a></li>
<li><a id="menu_join" class="ui-state-default ui-corner-all"  title='menu_register' href="{site_url}/auth/register"><?php echo lang('sg_register'); ?></a></li>
<?php endif; ?>
<li><a id="menu_about" class="ui-state-default ui-corner-all"  href="{site_url}/about"><?php echo lang('sg_menu_about'); ?></a></li>
</div>
